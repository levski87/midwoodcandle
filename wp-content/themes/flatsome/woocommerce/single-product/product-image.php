    ...
    <div class="product-image images">
    	<div class="iosSlider product-gallery-slider" style="min-height:<?php  $height = get_option('shop_single_image_size'); echo $height['height'].'px'; ?>">
			...
			<div class="slider gallery-popup">
                ...
                <div class="slide">
                	<span itemprop="image"><img src="<?php echo $src_small[0]; ?>"/></span>
				...
				<?php
					...
					if ( $attachment_ids ) {
						...
						foreach ( $attachment_ids as $attachment_id ) {
							...
							printf( '<div class="slide"><span>%s</span><a href="%s"><div class="zoom-button large icon-expand tip-top hide-for-small" data-tip="Zoom"></div></a></div>', wp_get_attachment_image( $attachment_id, apply_filters( 'single_product_large_thumbnail_size', 'shop_single' ) ), wp_get_attachment_url( $attachment_id ) );
